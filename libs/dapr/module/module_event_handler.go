...
type eventHandler interface {
	GetTopic() string
	GetEventFunction(logger provider.Logger) common.TopicEventHandler
}
...
func (h eventHandlerImpl) GetEventFunction(logger provider.Logger) common.TopicEventHandler {
